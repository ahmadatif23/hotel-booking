    ...
    <div className="w-full container flex justify-between gap-5">
      <div className="flex-1 gap-2.5 flex flex-col">
        ...
        <div className="flex items-center gap-1">
          <button className="bg-sky-900 text-white p-1 mr-2.5 font-bold text-xs rounded">8.9</button>
      ...
      <div className="flex-1 gap-2.5 flex flex-col">
        ...
        <div className="flex items-center gap-1">
          <button className="bg-sky-900 text-white p-1 mr-2.5 font-bold text-xs rounded">9.3</button>
      ...
      <div className="flex-1 gap-2.5 flex flex-col">
        ...
        <div className="flex items-center gap-1">
          <button className="bg-sky-900 text-white p-1 mr-2.5 font-bold text-xs rounded">8.8</button>
          <span className="text-sm">Excellent</span>
        </div>
      </div>
      <div className="flex-1 gap-2.5 flex flex-col">
